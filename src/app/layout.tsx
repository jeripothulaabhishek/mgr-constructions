...
import CalendlyModal from "@/components/forms/CalendlyModal";
...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="min-h-full bg-primary text-text-main flex flex-col selection:bg-gold/20 selection:text-text-main font-sans overflow-x-hidden">
        {/* Global Nav */}
        <Navbar />
        ...
        {/* Modal Portals triggered by events */}
        <CalendlyModal />
        <CostGuideModal />
        <CostCalculatorModal />

        {/* Cloudflare Turnstile explicit loader */}
        <Script
